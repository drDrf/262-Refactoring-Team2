...
public class ControlDesk extends Thread {
    ...
    public Vector getPartyQueue() {
        ...
        Vector<Party> queue = partyQueue.asVector();
     ...
     *
     * @param adding the model.ControlDeskObserver that will be subscribed
     */
     ...
     *
     * @param event the model.ControlDeskEvent to broadcast
     */
